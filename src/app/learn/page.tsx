        ...
        <div className="max-w-3xl mx-auto">
          ...
          <FadeIn>
            <p className="text-lg text-muted leading-relaxed">
              OWASP Precogly is rapidly emerging as a preferred alternative to
              commercial threat modeling tools. This hands-on course will teach
              you to combine the power of LLMs with open-source tooling to scale
              threat modeling in your organization without increasing the
              workload for your security team.
            </p>
          </FadeIn>
        </div>
      </Section>
          ...
          <FadeIn>
            <div className="bg-surface p-8 md:p-10 rounded-xl shadow-sm border border-primary/5">
              <p className="text-muted leading-relaxed text-lg">
                <strong className="text-primary">Vikramaditya Narayan</strong>{" "}
                is the creator and project leader of OWASP Precogly, an
                open-source alternative to commercial threat modeling tools. He
                leads the Bangalore chapter of Threat Modeling Connect, spoke at
                ThreatModCon DC on emergent risks in multi-agentic systems, and
                will be presenting at OWASP Vienna on AI and the Threat Modeling
                Manifesto. Vikramaditya has also created and delivered workshops
                on Large Language Models to corporate teams. He holds an MS from
                Carnegie Mellon University and is a Certified Threat Modeling
                Professional.
              </p>
            </div>
          </FadeIn>
